...
public:
	...
	static void generate_cvv(const char delimiter, std::ostringstream &oss);
	static void generate_date(const char delimiter, std::chrono::year_month_day start, std::chrono::year_month_day end, std::ostringstream &oss);
